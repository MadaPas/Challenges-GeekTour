package earlyjava.recursion.population;
...
public class Population {
    ...
    public static void getPopulation(double organisms, double percentage, int startDay, int endDay) {
        double currPop = (organisms * percentage) + organisms;
        if (startDay < endDay) {
            System.out.println("Day " + (startDay + 1) + " population: " + formatter.format(currPop));
            getPopulation(currPop, percentage, startDay + 1, endDay);
        }
